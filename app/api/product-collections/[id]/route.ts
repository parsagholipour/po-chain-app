...
import { productCollectionUpdateSchema } from "@/lib/validations/master-data";
...
export async function PATCH(
  ...
  const parsed = productCollectionUpdateSchema.safeParse(body);
...
export async function DELETE(
  ...
  try {
    const deleted = await prisma.productCollection.deleteMany({
      where: { id: pid.data.id, storeId },
    });
