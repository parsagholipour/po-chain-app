...
export function ShippingView() {
  ...
  const effectiveTab: ShippingType = isDistributor ? "purchase_order" : activeTab;

  const { data: shippings, isPending } = useQuery({
    queryKey: ["shipping", effectiveTab],
  ...
  }, [idFromUrl, clearIdParam, isDistributor, sessionStatus]);
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            {isDistributor
              ? "View purchase-order shipping records"
